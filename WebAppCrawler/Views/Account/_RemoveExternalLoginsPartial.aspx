<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<ICollection<WebAppCrawler.Models.ExternalLogin>>" %>

<% if (Model.Count > 0) { %>
    <h3>Зарегистрированные внешние учетные записи</h3>
    <table>
        <tbody>
        <% foreach (WebAppCrawler.Models.ExternalLogin externalLogin in Model) { %>
            <tr>
